const DateTemp = ({ temp, icon, date, nowDate, setNowDate }) => {
	...
	return (
		<div
			className={`dark:bg-gray-800 bg-gray-400 w-[100px] h-[140px] aspect-square rounded-md cursor-pointer ${
		...
		>
			<div className='flex flex-col justify-between items-center gap-1 p-2 h-full'>
				...
				<h2 className='text-gray-950 dark:text-gray-400 text-md'>{formattedDate}</h2>
			</div>
		</div>
	);
};
